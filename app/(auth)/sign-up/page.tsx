...
export default function SignUpForm() {
  ...
  return (
    <div suppressHydrationWarning={true} className="flex justify-center items-center min-h-screen bg-cyan-900">
      <div className="w-full max-w-md p-8 space-y-8 bg-red-800 rounded-lg shadow-md">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className='text-muted text-zinc-900 text-sm'>We will send you a verification code</p>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            />
            <Button  type="submit" className='w-full bg-cyan-900' disabled={isSubmitting}>
              {isSubmitting ? (
                <>
